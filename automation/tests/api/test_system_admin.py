...
class TestSystemStats:
    ...
    def test_get_system_stats(self, sysadmin_client):
        ...
        resp = sysadmin_client.get(f"{constants.API_URL}/api/v1/auth/system/stats")
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_stats_requires_auth(self):
        ...
        client = DM3Client()
        resp = client.get(f"{constants.API_URL}/api/v1/auth/system/stats")
        assert resp.status_code == 401

    @pytest.mark.api
    def test_stats_requires_system_admin(self, admin_client):
        """Stats endpoint should reject non-system-admin users."""
        resp = admin_client.get(f"{constants.API_URL}/api/v1/auth/system/stats")
...
class TestCompanyCRUD:
    ...
    def test_list_companies(self, sysadmin_client):
        ...
        resp = sysadmin_client.get(f"{constants.API_URL}/api/v1/auth/system/companies")
        assert resp.status_code == 200
        data = resp.json()
        assert "data" in data
    ...
    def test_create_company(self, sysadmin_client):
        ...
        resp = sysadmin_client.post(
            f"{constants.API_URL}/api/v1/auth/system/companies",
            json={
    ...
    def test_get_company(self, sysadmin_client):
        ...
        resp = sysadmin_client.get(f"{constants.API_URL}/api/v1/auth/system/companies/{company_id}")
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_update_company(self, sysadmin_client):
        ...
        resp = sysadmin_client.put(
            f"{constants.API_URL}/api/v1/auth/system/companies/{company_id}",
    ...
    def test_suspend_company(self, sysadmin_client):
        ...
        resp = sysadmin_client.delete(f"{constants.API_URL}/api/v1/auth/system/companies/{company_id}")
    ...
    def test_company_not_found(self, sysadmin_client):
        ...
        resp = sysadmin_client.get(
            f"{constants.API_URL}/api/v1/auth/system/companies/00000000-0000-0000-0000-000000000000"
        )
