  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-2 space-y-0.5">
        <SectionLabel label="Overview" color="#64748B" collapsed={c} />
        <SidebarNavItem to={ROUTES.dashboard} icon={<LayoutDashboard size={iconSize} />} label="Dashboard" collapsed={c} />
        <SidebarNavItem to={ROUTES.alerts} icon={<Bell size={iconSize} />} label="Alerts" badge={unreadCount} collapsed={c} />

        <SectionLabel label="🔒 SECURE" color="#3B82F6" collapsed={c} />
        <SidebarNavItem to={ROUTES.accessControl} icon={<DoorOpen size={iconSize} />} label="Access Control" collapsed={c} />
        <SidebarNavItem to={ROUTES.cctv} icon={<Video size={iconSize} />} label="CCTV" collapsed={c} />
        <SidebarNavItem to={ROUTES.intrusion} icon={<ShieldAlert size={iconSize} />} label="Intrusion" collapsed={c} />
        <SidebarNavItem to={ROUTES.intercom} icon={<Phone size={iconSize} />} label="Intercom" collapsed={c} />
        <SidebarNavItem to={ROUTES.aiDetection} icon={<Bot size={iconSize} />} label="AI Detection" collapsed={c} />
        <SidebarNavItem to={ROUTES.emergency} icon={<AlertTriangle size={iconSize} />} label="Emergency" collapsed={c} />

        <SectionLabel label="👤 MANAGE" color="#8B5CF6" collapsed={c} />
        <SidebarNavItem to={ROUTES.identities} icon={<Users size={iconSize} />} label="Identities" collapsed={c} />
        <SidebarNavItem to={ROUTES.visitors} icon={<UserPlus size={iconSize} />} label="Visitors" collapsed={c} />
        ...
        <SidebarNavItem to={ROUTES.parking} icon={<Car size={iconSize} />} label="Parking" collapsed={c} />
        <SidebarNavItem to={ROUTES.maintenance} icon={<Hammer size={iconSize} />} label="Maintenance" collapsed={c} />
        <SidebarNavItem to={ROUTES.guardTour} icon={<Shield size={iconSize} />} label="Guard Tour" collapsed={c} />
        <SidebarNavItem to={ROUTES.keys} icon={<Key size={iconSize} />} label="Keys" collapsed={c} />
        <SidebarNavItem to={ROUTES.iotEnergy} icon={<Zap size={iconSize} />} label="IoT & Energy" collapsed={c} />
      </div>
      ...
      <div className="flex-shrink-0">
        ...
        <div className="py-2 space-y-0.5">
          <SidebarNavItem to={ROUTES.aiAssistant} icon={<Brain size={iconSize} className="text-[#06B6D4]" />} label="AI Assistant" collapsed={c} />
          <SidebarNavItem to={ROUTES.settings} icon={<Settings size={iconSize} />} label="Settings" collapsed={c} />
        </div>
